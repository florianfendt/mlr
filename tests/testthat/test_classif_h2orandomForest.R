...
test_that("classif_randomForest", {
  ...
  testProbParsets ("classif.h2orandomForest", binaryclass.df, binaryclass.target, binaryclass.train.inds, old.probs.list, parset.list)
})